  ...
  return (
    ...
    >
      <div className="text-center py-2">
        ...
        <h3 className="text-xl font-black text-slate-900 dark:text-slate-100 mb-2 tracking-tight">Permanently Delete Task?</h3>
        <p className="text-sm text-slate-500 dark:text-slate-400 mb-8 max-w-[280px] mx-auto leading-relaxed">
          Are you sure you want to permanently delete <span className="text-slate-900 dark:text-slate-100 font-bold">"{taskTitle}"</span>? This action cannot be undone.
        </p>
