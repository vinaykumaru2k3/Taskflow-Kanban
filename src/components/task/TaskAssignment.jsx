    ...
    <div>
      ...
      <div className="relative">
        ...
        {assignedUser ? (
          ...
          <button
            onClick={() => setIsOpen(!isOpen)}
            className="w-full flex items-center justify-center gap-2 p-3 border-2 border-dashed border-slate-200 rounded-lg text-slate-400 hover:border-slate-300 hover:text-slate-500 transition-colors"
          >
            <UserPlus size={16} />
            ...
            <div className="p-2 border-b border-slate-100">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-3 py-2 bg-slate-50 rounded-lg text-sm focus:bg-white focus:outline-none focus:ring-1 focus:ring-slate-300"
                  autoFocus
                />
              </div>
            </div>
